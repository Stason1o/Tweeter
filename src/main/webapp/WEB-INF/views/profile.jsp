                ...
                <form:form action="${addAction}" commandName="user">
                    ...
                    <div class="row button-control">
                        <div class="col-lg-6 col-sm-6">
                            ...
                            <a id="deleteProfile" href="<c:url value='/delete/${user.id}' />"
                               class="btn btn-danger pull-left">Delete Profile</a>
                        </div>

                        <div class="col-lg-6 col-sm-6">
                            <form:input type="hidden" id="enabled" value="1" name="enabled" path="enabled"/>
                            <a href="<c:url value='/edit/${user.id}' />" class="btn btn-info pull-right">Edit</a>
                        </div>
                    </div>
                                            ...
                                            <c:when test="${userTweets.tweet != null}">
                                                ...
                                                <div class="retweet-box">
                                                    <p class="retweet-info">
                                                        ...
                                                        <span class="user-date">${userTweets.date}</span>
                                                        <%--<fmt:formatDate type="both" dateStyle="long" timeStyle="short"--%>
                                                                              <%--value="${listTweets.date}" />--%>
                                                    </p>
                                                    <p class="retweet-content-text">${userTweets.content}</p>
                                                </div>
                                            </c:when>
